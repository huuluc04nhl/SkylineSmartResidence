...
export default function FloorPlanExplorer() {
  ...
  const [activeTab, setActiveTab] = useState<'3D_MODEL' | 'PHOTO' | 'SPEC'>('3D_MODEL');
  ...
  return (
    <section id="floorplans" className="py-24 bg-[#0B0E14] border-b border-[#222B35] text-white">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div className="space-y-3 max-w-2xl">
            <div className="text-[11px] uppercase tracking-[0.25em] text-[#C5A880] font-semibold flex items-center gap-2">
              <Box className="w-4 h-4 text-[#C5A880]" /> Mô Hình 2D / 3D Tương Tác & Mặt Bằng Kỹ Thuật
            </div>
            <h2 className="text-3xl sm:text-4xl font-serif text-white font-bold">
              Khám Phá Bản Vẽ Mô Phỏng Căn Hộ 3D
            </h2>
            <p className="text-xs text-gray-400">
              Trải nghiệm mô phỏng không gian sống với góc nhìn 3D Isometric cắt lớp, bản vẽ kiến trúc 2D CAD và hệ thống cảm biến thông minh IoT thời gian thực.
            </p>
          </div>
          ...
          <div className="lg:col-span-8 space-y-4">
            ...
            <div className="p-4 bg-[#121820] border border-[#222B35] flex flex-wrap items-center justify-between gap-4 rounded">
              ...
              <div className="flex bg-[#0D1117] p-1 border border-[#222B35] rounded">
                ...
                >
                  <Box className="w-3.5 h-3.5" /> Mô Hình 3D / 2D
                </button>
                <button
                  type="button"
